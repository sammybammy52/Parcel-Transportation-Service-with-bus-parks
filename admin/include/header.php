        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <div class="dropdown show">
              ...
              <span class="fas fa-users"></span> Manage Parks
              </a>

              <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <a class="dropdown-item" href="view_reg_parks.php">View Registered Parks</a>
                <a class="dropdown-item" href="view_nom_parks.php">View Nominated Parks</a>
                <a class="dropdown-item" href="nom_park.php">Nominate Parks</a>
              </div>
            </div>
          </li>
          <li class="nav-item">
