...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="./sellerdash/assets/css/material-dashboard.min.css" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-200">
            ...
            <div class="col-12">
                <div class="card my-4">
                    ...
                    <div class="card-body px-0 pb-2 position-relative">
                        ...
                        <form class="m-7" method="POST" action="orderpagehandler.php">
                            <div class="mb-3">
    ...
    <script src="./sellerdash/assets/js/material-dashboard.min.js?v=3.0.0"></script>
</body>
