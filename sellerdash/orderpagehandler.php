...
if (isset($_POST['order'])) {
    ...
    $sql = "insert into `tbl_orders` (package_weight,quantity,length,width,height,dropoff_park,seller_number,recipient_number,order_number,seller_id,dstate,dlga,dpark,order_status) values($package_weight,$quantity,$length,$width,$height,$dropoff_park,'$seller_number','$recipient_number','$order_number',$seller_id,$dstate,$dlga,$dpark,'$order_status')";
    ...
    if ($result) {
        ...
        echo 'Error Occured while processing';
